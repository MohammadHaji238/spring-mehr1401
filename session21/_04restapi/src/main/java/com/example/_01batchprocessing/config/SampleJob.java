...
import com.example._01batchprocessing.service.StudentService;
...
*/
 ...
 /*   @Bean
  ...
  /*  @Bean
    ...
    {
        ItemReaderAdapter<Student> studentItemReaderAdapter=new ItemReaderAdapter<>();


        studentItemReaderAdapter.setTargetObject(studentService);
        studentItemReaderAdapter.setTargetMethod("getStudent");

        return studentItemReaderAdapter;
    }
